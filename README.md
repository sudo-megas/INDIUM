...
<p>
  <img alt="Version"      src="https://img.shields.io/badge/version-1.0.0--4-E95420?style=for-the-badge">
  <img alt="Release date" src="https://img.shields.io/badge/released-2026--08--10-E95420?style=for-the-badge">
...
Download `indium-1.0.0-4-x86_64.pkg.tar.zst` from the Releases page:

```sh
sudo pacman -U indium-1.0.0-4-x86_64.pkg.tar.zst
```

### 3.B Debian / Ubuntu

Download `indium_1.0.0-4_amd64.deb` from the Releases page:

```sh
sudo apt install ./indium_1.0.0-4_amd64.deb
```
...
`indium-1.0.0-4-x86_64.tar.gz` is the `.deb`'s binary with no packaging around it, so it carries
